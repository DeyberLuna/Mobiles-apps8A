package com.example.actividad_final1;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtSearch = findViewById(R.id.input_text);
        btnSearch = findViewById(R.id.btn_search);
        lblCurrent = findViewById(R.id.text_current);
        lblmin = findViewById(R.id.text_min);
        lblmax = findViewById(R.id.text_max);
